...
sudo ./behavioral-model/targets/simple_switch/simple_switch ./myTelemetry/collector_switch_25/switch.json -i 1@enp3s0f0 -i 2@enp65s0f0 -i 3@eno2 -i 4@enp65s0f1  --thrift-port 9090  \
--log-file /home/adminsssa/p4-collector/logs/logs25/logs_25  & sleep 10
