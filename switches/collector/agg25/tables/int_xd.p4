...
control ExportData(inout headers_t hdr,
    ...
    Params: srv_ip = ip address of the telemetry server
            ...
            egress_interface = physical port of the switch to forward the frame on
    */
    action forward_postcard(bit<32> srv_ip,
        ...
        // calculate the length of the telemetry aggregated header
        bit<16> telemetryLength = (bit<16>)( PACKET_AGGREGATOR_THRESHOLD * REPORT_FIXED_HEADER_LEN_BYTES);
