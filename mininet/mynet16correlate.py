...
network_switch_path = 'network_switch_99_flow_id/switch.json'
collector_path = 'collector16correlate/switch.json'
...
class MyTopo(Topo):
    ...
    def __init__(self, sw_path, json_path, thrift_port, pcap_dump, enable_debugger, n, **opts):
        ...
        s0 = self.addSwitch('s0',
                                sw_path = sw_path,
                                json_path = json_path + collector_path,
                                thrift_port = 9090,
                                pcap_dump = pcap_dump,
        ...
        s1 = self.addSwitch('s1',
                                sw_path = sw_path,
                                json_path = json_path + network_switch_path,
                                thrift_port = 9091,
                                pcap_dump = pcap_dump,
                                enable_debugger = enable_debugger
                                )
